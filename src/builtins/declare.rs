        ...
        match declaration {
            ...
            crate::core::CommandArg::Assignment(assignment) => {
                match &assignment.name {
                    crate::parser::ast::AssignmentName::VariableName(var_name) => {
                        name = var_name.to_owned();
                        assigned_index = None;
                    }
                    crate::parser::ast::AssignmentName::ArrayElementName(var_name, index) => {
                        if matches!(
                            assignment.value,
                            crate::parser::ast::AssignmentValue::Array(_)
                        ) {
