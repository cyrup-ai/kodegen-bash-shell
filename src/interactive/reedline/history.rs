...
impl ReedlineHistory {
    fn lock_shell(&self) -> tokio::sync::MutexGuard<'_, crate::core::Shell> {
...
fn brush_history_item_to_reedline(item: &crate::core::history::Item) -> reedline::HistoryItem {
...
#[expect(unused)]
fn reedline_history_item_to_brush(item: &reedline::HistoryItem) -> crate::core::history::Item {
    // TODO: implement more fields when they are added to Item
    crate::core::history::Item {
...
fn brush_error_to_reedline(error: crate::core::Error) -> reedline::ReedlineError {
    reedline::ReedlineError::from(std::io::Error::other(error))
}

fn reedline_history_query_into_brush(
    query: reedline::SearchQuery,
) -> reedline::Result<crate::core::history::Query> {
    let mut result = crate::core::history::Query {
        direction: match query.direction {
            reedline::SearchDirection::Forward => crate::core::history::Direction::Forward,
            reedline::SearchDirection::Backward => crate::core::history::Direction::Backward,
        },
    ...
    if let Some(cmdline_filter) = query.filter.command_line {
        result.command_line_filter = match cmdline_filter {
            reedline::CommandLineSearch::Exact(cmdline) => {
                Some(crate::core::history::CommandLineFilter::Exact(cmdline))
            }
            reedline::CommandLineSearch::Substring(cmdline) => {
                Some(crate::core::history::CommandLineFilter::Contains(cmdline))
            }
            reedline::CommandLineSearch::Prefix(cmdline) => {
                Some(crate::core::history::CommandLineFilter::Prefix(cmdline))
            }
        }
    }
...
fn get_shell_history<'a>(
    shell: &'a tokio::sync::MutexGuard<'_, crate::core::Shell>,
) -> Result<&'a crate::core::history::History, reedline::ReedlineError> {
    shell.history().ok_or({
...
fn get_shell_history_mut<'a>(
    shell: &'a mut tokio::sync::MutexGuard<'_, crate::core::Shell>,
) -> Result<&'a mut crate::core::history::History, reedline::ReedlineError> {
