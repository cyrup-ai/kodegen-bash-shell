...
pub(crate) struct TermLineReader {
    term_mode: crate::core::terminal::AutoModeGuard,
}

impl TermLineReader {
    pub fn new() -> Result<Self, ShellError> {
        let reader = Self {
            term_mode: crate::core::terminal::AutoModeGuard::new(
                crate::core::openfiles::OpenFile::Stdin(std::io::stdin()),
            )?,
        };

        let settings = crate::core::terminal::Settings::builder()
            .echo_input(false)
            .line_input(false)
