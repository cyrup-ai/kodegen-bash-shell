...
pub struct Context<'a> {
    ...
    pub tokens: &'a [&'a crate::parser::Token],
}
...
impl Spec {
    ...
    pub async fn get_completions(
        ...
        shell: &mut Shell,
        context: &Context<'_>,
    ) -> Result<Answer, super::error::Error> {
        ...
        if let Some(word_list) = &self.word_list {
            ...
            let words =
                super::expansion::full_expand_and_split_str(shell, &params, word_list).await?;
            for word in words {
...
impl Config {
    ...
    pub async fn get_completions(
        ...
        let mut adjusted_tokens: Vec<&crate::parser::Token> = tokens.iter().collect();
        ...
        let empty_token =
            crate::parser::Token::Word(String::new(), crate::parser::TokenLocation::default());
    ...
    fn tokenize_input_for_completion(shell: &Shell, input: &str) -> Vec<crate::parser::Token> {
        const FALLBACK: &str = " \t\n\"\'@><=;|&(:";
...
fn simple_tokenize_by_delimiters(input: &str, delimiters: &[char]) -> Vec<crate::parser::Token> {
    //
    ...
    for piece in input.split_inclusive(delimiters) {
        ...
        tokens.push(crate::parser::Token::Word(
            piece.to_string(),
            crate::parser::TokenLocation {
                ...
                .into(),
                end: crate::parser::SourcePosition {
                    index: end,
                    line: 1,
                    column: end + 1,
                }
